...
export const ChatBot = ({ convaiClient, onConnect, }) => {
        ...
        switch (message.type) {
            case "user-llm-text":
                return (_jsx("div", { style: {
                        padding: "8px 0",
                    }, children: _jsxs("div", { className: "items-end", style: {
                            display: "flex",
                            flexDirection: "column",
                            alignItems: "flex-end",
                            maxWidth: "100%",
                        }, children: [_jsx("div", { className: "transparent border border-emerald-500/30 rounded-2xl px-6 py-4 shadow-lg backdrop-blur-sm", style: { padding: "12px 16px" }, children: _jsx("p", { className: "text-emerald-100 text-sm leading-relaxed", children: message.content }) }), _jsx("div", { className: "flex items-center mt-2 space-x-2", style: {
                                    marginRight: "12px",
                                    marginTop: "4px",
                                }, children: _jsxs("span", { className: "text-emerald-400/60 text-xs font-medium", children: ["You ", formatTime(message.timestamp)] }) })] }) }, message.id));
            case "bot-llm-text":
                return (_jsx("div", { style: {
                        padding: "8px 0",
                    }, children: _jsxs("div", { className: "items-start", style: {
                            display: "flex",
                            flexDirection: "column",
                            maxWidth: "85%",
                        }, children: [_jsx("div", { className: "bg-emerald-500/20  border border-emerald-500/30 rounded-2xl px-6 py-4 shadow-lg backdrop-blur-sm", style: { padding: "12px 16px" }, children: _jsx("p", { className: "text-slate-100 text-sm leading-relaxed", children: message.content }) }), _jsx("div", { className: "flex items-center mt-2 space-x-2", style: {
                                    marginLeft: "12px",
                                    marginTop: "4px",
                                }, children: _jsxs("span", { className: "text-slate-400/60 text-xs font-medium", children: ["Convai ", formatTime(message.timestamp)] }) })] }) }, message.id));
            case "bot-emotion":
    ...
    return (_jsx(RoomContext.Provider, { value: convaiClient.room, children: _jsxs("div", { className: "relative rounded-4xl glass", style: { width: "40vw", maxWidth: "550px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }, children: [_jsx("div", { className: "rounded-t-2xl flex items-center justify-around" }), _jsx("div", { className: `rounded-b-2xl overflow-hidden transition-all duration-300 ${isMinimized ? "w-80 h-16" : "w-96 h-[500px]"}`, style: {
                        minHeight: 190,
                        display: "flex",
                        flexDirection: "column",
                        ...
                        width: "100%",
                                    ...
                                    overflowY: "scroll",
                                        ...
                                        alignItems: "center",
                                        gap: "8px",
                                    }, children: [_jsx("button", { onClick: () => audioControls.toggleAudio(), className: `px-3 py-3 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 text-white ${audioControls.isAudioMuted
                                                ? "bg-red-500/20 border border-red-500/30 hover:bg-red-500/30"
                                                : "bg-emerald-500/20 border border-emerald-500/30 hover:bg-emerald-500/30"}`, title: audioControls.isAudioMuted ? "Unmute Microphone" : "Mute Microphone", children: _jsx(MicrophoneIcon, { width: 24, height: 24 }) }), _jsx("input", { ref: inputRef, type: "text", value: inputText, onChange: (e) => setInputText(e.target.value), onKeyPress: handleKeyPress, placeholder: "Type your message...", disabled: isSending, className: "px-4 py-3 rounded-lg flex-1", style: {
                                                color: "black",
                                                outline: "none",
                                                flex: 1,
