...
import { TrackType, TrackSource, Room, ParticipantInfo, TrackInfo, SpeakerInfo } from "./livekit_models";
...
export declare const SetSimulcastLayers: {
    encode(message: SetSimulcastLayers, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): SetSimulcastLayers;
